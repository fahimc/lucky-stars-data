...
This repository intentionally contains only opaque family/child IDs, ticket numbers, draw numbers, timestamps, match counts, and reward values. Never commit names, email addresses, passwords, access tokens, notes about children, or any other personal data.
